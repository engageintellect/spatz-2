<script lang="ts">
	...
	import FeaturesFeed from './FeaturesFeed.svelte';
	...
	<div class="flex flex-col gap-10">
		<div>
			...
			<div class="mt-2 flex w-full gap-2">
				<a
					...
					class="my-2 flex-1"
				>
					<Button variant="default" class="w-full bg-orange-500 hover:bg-orange-400">
		...
		<div class="">
			...
			<p class="mt-2 text-lg">
				...
				you need to get started, and move quickly:
			</p>
		...
		<div>
			...
			<div>
				...
				<p class="mt-2">Run the below commands to get started.</p>
				<div>
					<div class="my-2 overflow-x-auto text-nowrap rounded-lg bg-neutral-800 p-5 text-white">
						$ wget
