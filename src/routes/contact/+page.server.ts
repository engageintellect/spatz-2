...
import { GOOGLE_FORM_URL, FORM_PAYLOAD_FIRST_NAME, FORM_PAYLOAD_LAST_NAME, FORM_PAYLOAD_EMAIL, FORM_PAYLOAD_TYPE, FORM_PAYLOAD_PRIORITY, FORM_PAYLOAD_MESSAGE } from "$env/static/private";
...
export const actions: Actions = {
  default: (async (event) => {
    ...
    const payload = new URLSearchParams({
      ...
      [FORM_PAYLOAD_PRIORITY]: form.data.priority,
